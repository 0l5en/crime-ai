...
export interface paths {
    ...
    "/evidence-report": {
        ...
        put?: never;
        /** Create a new report for an evidence. If a report already exist for the given identifier (userId, personId, evidenceId), this operation will do nothing. */
    ...
    "/autopsy-report-request": {
        ...
        put?: never;
        /** Create a new request for autopsy report of a victim. If a request already exist for the given authenticated user and given victimId, this operation will do nothing. */
    ...
    "/notification": {
        ...
        /** Get a list of notifications of the authenticated user. */
    ...
    "/user-profile-my-password": {
        ...
        get?: never;
        /** Send email to authenticated user to reset the password. */
        put: operations["sendUpdatePasswordMail"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
...
export interface components {
    schemas: {
        ...
        EvidenceDto: {
            ...
            /** @enum {string} */
            evidenceType: "DIGITAL" | "FORENSIC" | "BALLISTIC" | "DOCUMENT" | "TRACE" | "OTHER";
            textToImage: string;
...
export interface operations {
    ...
    sendUpdatePasswordMail: {
        parameters: {
            query: {
                /** @description A URI to which the user is redirected after successfully changing their password. */
                redirectUri: string;
            };
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            /** @description if the underlying service endpoint returned an error */
            502: {
                headers: {
                    [name: string]: unknown;
                };
