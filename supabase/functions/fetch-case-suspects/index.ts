...
Deno.serve(async (req) => {
  console.log('Starting fetch-case-suspects function...')
  ...
  try {
    ...
    console.log(`Fetching suspects for case ID: ${caseId}`)
    ...
    const apiUrl = `${CRIME_AI_API_BASE_URL}/crimecase/${caseId}/suspect`
